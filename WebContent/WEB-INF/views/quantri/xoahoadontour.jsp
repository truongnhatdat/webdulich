  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> ${tin.tieude}</p></div>
   		 </div>
	</div>

   	<div class="container">
       <h4><strong>Xóa hóa đơn tour</strong></h4>
        <br>
        <p>Xem lại tin đầy đủ trước khi xóa</p>
          <form:form action="quantri/xoacttour.htm" modelAttribute="hoadontour">
                <div class="mt-3">
                    <label><strong>ID</strong></label>
                    <br>
               		<form:input class="form-control" readonly="true" type="text" path="idHDT"/>
                </div>
                <div class="mt-3">
                   <label><strong>ID Tour</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="idTour.idTour"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>ID Khách Hàng</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="idKH.idKH"/>
                 </div>
                <div class="mt-3">
                   <label><strong>Ngày đi</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="ngaydi"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Ngày về</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="ngayve"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Số lượng người lớn</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="soluongnguoilon"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Số lượng trẻ em</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="soluongtreem"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Ngày đặt</strong></label>
                 	<br>
               		<form:input class="form-control" readonly="true" type="text" path="ngaydat"/>
                 </div>
                  <div class="mt-3">
                   <label><strong>Thanh toán</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="thanhtoan"/>
                 </div>
                  <div class="mt-3">
                   <label><strong>Tổng tiền</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="text" path="tongtien"/>
                 </div>
               <br>
