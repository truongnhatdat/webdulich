 	...
 	<div class="container tieude text-info">
       ...
       <h4><strong>Xóa hóa đơn dịch vụ</strong></h4>
        ...
        <p>Xem lại tin đầy đủ trước khi xóa</p>
          <form:form action="quantri/xoahoadondv.htm" modelAttribute="hddv">
          		 <div class="mt-3">
                ...
                <div class="mt-3">
                   <label><strong>ID Dịch Vụ</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" path="idDV.idDV"></form:input>
                 </div>
   				<div class="mt-3">
                   <label><strong>ID Khách Hàng</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" path="idKH.idKH"></form:input>
                 </div>
                <div class="mt-3">
                   <label><strong>Ngày nhận</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="date" path="ngaynhan"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Ngày trả</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="date" path="ngaytra"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Ngày đặt</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" type="date" path="ngaydat"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Số lượng</strong></label>
                   <br>
               	   <form:input readonly="true" class="form-control" type="number" path="soluong"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Loại</strong></label>
                   <br>
               	 	<form:input class="form-control" readonly="true" path="loai"/>
                 </div>
                  <div class="mt-3">
                   <label><strong>Tình trạng thanh toán</strong></label>
                   <br>
               	   <form:input readonly="true" class="form-control" path="thanhtoan"/>
                 </div>
               <br>
