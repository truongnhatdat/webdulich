  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
	...
	<div class="container">
    	<h2>Danh sách tour du lịch</h2>
  		<p>Bảng hiển thị danh sách các dịch vụ du lịch hiện có của công ty:</p>
        <table class="table" border="1px;">
    		<thead class="thead-dark">
   			 ...
   			 <tbody>
      			<c:forEach var="dvl" items="${dvdlich}">
      				<tr>
      					<td>${dvl.idDV}</td>
      					<td>${dvl.tenDV}</td>
      					<td><img src="resources/hinh/${dvl.hinhanh}" style="width:110px; height:90px;"></td>
      					<td>${dvl.noidung}</td>
      					<td>${dvl.idUser.idUser}</td>
      					<td>
      						<form:form action="quantri/themdichvu.htm" method="GET"><button>Thêm</button></form:form> 
      						<a href="quantri/${dvl.tenDV}.htm?lnkdelete" method="GET"><button>Xóa</button></a>
      						<a href="quantri/${dvl.tenDV}.htm?lnkedit" method="GET"><button>Sửa</button></a> 
      					 </td>
      				</tr>
      			</c:forEach>
    		</tbody>
