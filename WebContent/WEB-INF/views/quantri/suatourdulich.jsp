  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Sửa thông tin tour <i class="fas fa-angle-right"></i> ${tours.tenTour} <i class="fas fa-angle-right"></i> ${message}</p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Sửa tour</strong></h4>
                <br>
            
                <form:form action="quantri/suatourdulich.htm" modelAttribute="tours" enctype="multipart/form-data">
                	<div>
                    ...
                    <div class="mt-3">
                    	<label><strong>Tên Tour</strong></label>
                 	    <br>
               		     <form:input class="form-control" type="text" path="tenTour" />
               		      <form:errors path="TenTour" style="color: red;font-style: italic;"></form:errors>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Hình ảnh</strong></label>
                    	<br>
                 	 	<form:input type="text" class="form-control" path="hinhanh"/>
