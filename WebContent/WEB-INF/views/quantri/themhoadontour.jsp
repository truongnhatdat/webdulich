  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
   	...
   	<div class="container">
       <h4><strong>Thêm hóa đơn tour</strong></h4>
        <br>
        <p>Xem lại tin đầy đủ trước khi thêm</p>
          <form:form action="quantri/themcttour.htm" modelAttribute="cttour">
                <div class="mt-3">
                ...
                <div class="mt-3">
                 ...
                 <div class="mt-3">
                   ...
                   <br>
               	   ...
               	   <form:errors path="Ngayve" style="color: red;font-style: italic;"></form:errors>
                 </div>
                 <div class="mt-3">
