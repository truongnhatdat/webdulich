  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Sửa thông tin dịch vụ <i class="fas fa-angle-right">${dv.tenDV}</i></p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Sửa dịch vụ</strong></h4>
                <br>
                <p>Xem thông tin đầy đủ trước khi sửa</p>
                <form:form action="quantri/suadichvu.htm" modelAttribute="dv" enctype="multipart/form-data">
                	<div>
                    ...
                    <div class="mt-3">
                    	<label><strong>Tên Tour</strong></label>
                 	    <br>
               		     <form:input class="form-control" type="text" path="tenDV"/>
               		      <form:errors path="TenDV" style="color: red;font-style: italic;"></form:errors>
                    </div>
                    <div class="mt-3">
