  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Thêm thông tin dịch vụ <i class="fas fa-angle-right"></i>
    	${message}</p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Thêm dịch vụ</strong></h4>
                <br>
                <p>Điền thông tin đầy đủ trước khi thêm</p>
                <form:form action="quantri/themdichvudulich.htm" modelAttribute="dichvu" enctype="multipart/form-data">
                	<div>
                    	<label><strong>Id</strong></label>
                 	    <br>
               		     <form:input class="form-control" type="text" path="idDV"/>
               		     <form:errors path="IdDV" style="color: red;font-style: italic;"></form:errors>
                    </div>
                    <div class="mt-3">
