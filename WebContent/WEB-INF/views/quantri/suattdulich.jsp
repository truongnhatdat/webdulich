  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> ${ttdlich.tieude} <i class="fas fa-angle-right"></i>
    	${message}</p></div>
   		 </div>
	</div>

   	<div class="container">
       <h4><strong>Sửa thông tin du lịch</strong></h4>
        <br>
        <p>Xem lại tin đầy đủ trước khi sửa</p>
           <form:form action="quantri/suattdulich.htm" modelAttribute="ttdlich" enctype="multipart/form-data">
                <div class="mt-3">
                    <label><strong>IdTin</strong></label>
                    <br>
               		<form:input class="form-control" type="text" readonly="true"  path="idTTin"/>
                </div>
                <div class="mt-3">
                   <label><strong>Tiêu đề</strong></label>
                   <br>
               	   <form:input class="form-control" type="text" path="tieude"/>
               	   	<form:errors path="Tieude" style="color: red;font-style: italic;"></form:errors>
                 </div>
                 ...
                 <div class="mt-3">
                    ...
                    <img src="resources/hinh/${ttdlich.hinhanh}" style="width:110px; height:90px;">
                 	 <br>
               		 <form:input class="form-control" type="text" path="hinhanh"/>
               		 <br>
                 ...
                 <div class="mt-3">
                   <label><strong>Ngày đăng</strong></label>
                 	<br>
               		<form:input type="date" path="ngaydang" />
                 </div>
                 <div>
