  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p>Quản trị <i class="fas fa-angle-right"></i> Thêm thông tin du lịch <i class="fas fa-angle-right"></i>
    	${message}</p></div>
   		 </div>
	</div>
	
    		<div class="container">
            	<h4><strong>Thêm thông tin du lịch</strong></h4>
                <br>
                <p>Điền thông tin đầy đủ trước khi thêm</p>
                <form:form action="quantri/themttdulich.htm" modelAttribute="ttdlich" enctype="multipart/form-data">
