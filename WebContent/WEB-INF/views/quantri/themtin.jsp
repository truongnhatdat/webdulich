  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Thêm tin du lịch <i class="fas fa-angle-right"></i> ${message}</p></div>
   		 </div>
	</div>
    		...
    		<div class="container">
                ...
                <form:form action="quantri/themtindulich.htm" modelAttribute="tins" enctype="multipart/form-data">
