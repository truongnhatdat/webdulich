  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Xóa thông tin tour <i class="fas fa-angle-right"></i> ${tours.tenTour}</p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Xóa tour</strong></h4>
                <br>
            
                <form:form action="quantri/xoatourdulich.htm" modelAttribute="tours">
                	<div>
                    	<label><strong>Id</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="idTour"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Tên Tour</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="tenTour" />
                    </div>
                    <div class="mt-3">
                    	<label><strong>Hình ảnh</strong></label>
                    	<br>
                    	<img style="width:110px; height:90px;" src="resources/hinh/${tours.hinhanh}">
                 	    <br>
               		     <form:input class="form-control" readonly="true" path="hinhanh"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Khách sạn</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="khachsan"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Di chuyển</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="dichuyen"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Thời gian</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="thoigian"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Khởi hành</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="khoihanh"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Giá</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="number" path="gia"/>
                    </div>
                    <div class="mt-3">
                    ...
                    <div class="mt-3">
                    	<label><strong>IdUser</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="idUser.idUser" placeholder="IdUser"/>
                    </div>
                    <br>
