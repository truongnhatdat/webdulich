  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p>Quản trị<i class="fas fa-angle-right"></i> Thêm thông tin khách hàng <i class="fas fa-angle-right"></i> ${message} </p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Thêm khách hàng</strong></h4>
                <br>
                <p>Điền thông tin đầy đủ trước khi thêm</p>
                <form:form action="quantri/themkhachhang.htm" modelAttribute="kh">
                	
                    <div class="mt-3">
                    	<label><strong>Tên Khách Hàng</strong></label>
                 	    <br>
               		     <form:input class="form-control" type="text" path="tenKH" placeholder="Tên Khách Hàng"/>
                    ...
                    <div class="mt-3">
                    	<label><strong>Nội dung</strong></label>
                 	    <br>
               		     <form:textarea rows="4" class="form-control" type="text" path="noidung" placeholder="Nội dung"/>
                    </div>
                    <br>
