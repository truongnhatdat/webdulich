  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
   	...
   	<div class="container">
       <h4><strong>Sửa hóa đơn tour</strong></h4>
        <br>
        <p>Xem lại tin đầy đủ trước khi sửa</p>
          <form:form action="quantri/suacttour.htm" modelAttribute="hoadontour">
          		<div class="mt-3">
                   <label><strong>ID</strong></label>
                   <br>
               	   <form:input type="text" readonly="true" path="idHDT"/>
                 </div>
                <div class="mt-3">
                   <label><strong>Tên Tour</strong></label>
                   <br>
               	   <form:select path="idTour.idTour" items="${tdlich}" itemValue="idTour" itemLabel="tenTour"></form:select>
                 </div>
   				<div class="mt-3">
                ...
                <div class="mt-3">
                 ...
                 <div class="mt-3">
                   ...
                   <br>
               	   <form:input type="date" path="ngayve"/>
                 </div>
                 <div class="mt-3">
                   <label><strong>Số lượng người lớn</strong></label>
                   <br>
               	   <form:input class="form-control" type="number" path="soluongnguoilon"/>
               	      <form:errors path="Soluongnguoilon" style="color: red;font-style: italic;"></form:errors>
                 </div>
                 <div class="mt-3">
                   <label><strong>Số lượng trẻ em</strong></label>
                   <br>
               	   <form:input class="form-control" type="number" path="soluongtreem"/>
               	   <form:errors path="Soluongtreem" style="color: red;font-style: italic;"></form:errors>
                 </div>
                  <div class="mt-3">
                  ...
                  <div class="mt-3">
                   <label><strong>Tổng số tiền</strong></label>
                   <br>
               	   <form:input class="form-control" type="number" path="tongtien"/>
                 </div>
               <br>
