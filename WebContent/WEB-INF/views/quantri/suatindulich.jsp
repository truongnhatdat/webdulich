  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> ${tin.tieude} <i class="fas fa-angle-right"></i> ${message}</p></div>
   		 </div>
	</div>
	
   	<div class="container">
       <h4><strong>Sửa tin du lịch</strong></h4>
        <br>
        <p>Điền thông tin đầy đủ trước khi sửa</p>
           <form:form action="quantri/suatindulich.htm" modelAttribute="tin" enctype="multipart/form-data">
           
           		<div class="mt-3">
                   <label><strong>Id</strong></label>
                   <br>
               	   <form:input class="form-control" readonly="true" path="idTin" type="text"/>
                 </div>
