  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
   	...
   	<div class="container">
       <h4><strong>Xóa tin du lịch</strong></h4>
        <br>
        <p>Xem lại tin đầy đủ trước khi xóa</p>
           <form:form action="quantri/xoatindulich.htm" modelAttribute="tin">
                <div class="mt-3">
                    <label><strong>IdTin</strong></label>
                    <br>
               		<form:input class="form-control" readonly="true" type="text" path="idTin"/>
                </div>
                <div class="mt-3">
                 ...
                 <div class="mt-3">
                    ...
                    <br>
                    <img src="resources/hinh/${tin.hinhanh}" style="width:110px; height:90px;">
                 	 <br>
                 ...
                 <div class="mt-3">
                   <label><strong>Ngày đăng</strong></label>
                 	<br>
               		<form:input class="form-control" type="text" readonly="true" path="ngaydang"/>
                 </div>
                 <div>
