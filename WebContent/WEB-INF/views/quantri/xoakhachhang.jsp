  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Xóa thông tin khách hàng</p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Xóa khách hàng</strong></h4>
                <br>
                <p>Điền thông tin đầy đủ trước khi xóa</p>
                <form:form action="quantri/xoakhachhang.htm" modelAttribute="kh">
                	<div class="mt-3">
                    ...
                    <div class="mt-3">
                    	<label><strong>Tên Khách Hàng</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="tenKH" />
                    </div>
                    <div class="mt-3">
                    	<label><strong>Số điện thoại</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="sodienthoai"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Địa chỉ</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="diachi" />
                    </div>
                    <div class="mt-3">
                    	<label><strong>Email</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="email" />
                    </div>
                    <div class="mt-3">
                    	<label><strong>Nội dung</strong></label>
                 	    <br>
               		     <form:textarea rows="4" readonly="true" class="form-control" type="text" path="noidung"/>
                    </div>
                    <br>
