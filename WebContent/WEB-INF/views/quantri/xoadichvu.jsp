  ...
  <a class="navbar-brand"><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a>
    ...
    <ul class="navbar-nav mr-auto drop-menu">
 	...
 	<div class="container tieude text-info">
    	...
    	<div><p><a href="#">Quản trị</a> <i class="fas fa-angle-right"></i> Xóa thông tin dịch vụ</p></div>
   		 </div>
	</div>
    		<div class="container">
            	<h4><strong>Xóa dịch vụ</strong></h4>
                <br>
                <p>Xem thông tin đầy đủ trước khi xóa</p>
                <form:form action="quantri/xoadichvu.htm" modelAttribute="dv">
                	<div>
                    	<label><strong>Id</strong></label>
                 	    <br>
               		     <form:input class="form-control" readonly="true" type="text" path="idDV"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Tên Tour</strong></label>
                 	    <br>
               		     <form:input readonly="true" class="form-control" type="text" path="tenDV"/>
                    </div>
                    <div class="mt-3">
                    	<label><strong>Hình ảnh</strong></label>
                 	    <br>
                    	<img style="width:110px; height:90px;" src="resources/hinh/${dv.hinhanh}">
                 	    <br>
               		     <form:input readonly="true" class="form-control" path="hinhanh"/>
                    </div>
                    ...
                    <div class="mt-3">
                    	<label><strong>IdUser</strong></label>
                 	    <br>
               		     <form:input readonly="true" class="form-control" type="text" path="idUser.idUser"/>
                    </div>
                    <br>
