...
<body>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-content bg-warning">
        	<c:forEach var="tdl" items="${tdlich}">
        		<a class="dropdown-item" href="dulichbien/${dvdl.tenDV}.htm?Loaddv">${tdl.tenTour}</a>
        	</c:forEach>
        </div>
      </li>
       <li class="nav-item dropdown">
 ...
 <div class="modal fade" id="myModal">
	...
	<div class="container-fluid mt-4">
		<label class="bg-warning btn mt-2"> <h3 style="color:white">Tour Du Lịch</h3></label>
	<div class="row mt-3">
		<c:forEach var="tdl" items="${tdlich}">
			 <div class="col-md-3 col-sm-6 col-xs-12 mb-2">
				<div class="card" style="width: 100%;">
  					<a href="dulichbien/${tdl.tenTour}.htm?load"><img src="resources/hinh/${tdl.hinhanh}" class="card-img-top"></a>
  					<div class="card-body">
   			 		<a href="dulichbien/${tdl.tenTour}.htm?load" style="text-decoration: none;"><h5 class="card-title">${tdl.tenTour}</h5></a>
   			 		<div class="card-text">
             			<span class="Gia text-info"><h6 style="font-weight:bold"><i class="fas fa-money-bill-alt"></i> Giá : <fmt:formatNumber value="${tdl.gia}" type="number"/>đ</h6></span>
                		<span class="Thoigian"><h6><i class="fas fa-clock text-info"></i> Thời Gian : ${tdl.thoigian}</h6></span>
             		</div>
    			<a href="dulichbien/${tdl.tenTour}.htm?load" class="btn btn-primary btn-outline-warning text-white">ĐẶT TOUR</a>
 			 		</div>
				</div>
			</div>
		</c:forEach>
