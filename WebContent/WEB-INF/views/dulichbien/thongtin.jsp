...
<body>
 ...
 <!-- phan model -->
	...
	<label class="btn bg-warning mt-2"><h3 style="color:white">Thông Tin Du Lịch</h3></label>
	  <div class="row mt-3">
	  	<c:forEach var="ttdl" items="${ttdl}">
	  		<div class="col-md-3 col-sm-6 col-xs-12 mb-2">
        		<div class="card" style="width: 100%;">
  				<a href="dulichbien/${ttdl.tieude}.htm?loadttdulich"><img src="resources/hinh/${ttdl.hinhanh}" class="card-img-top"></a>
 				<div class="card-body">
    				<a href="dulichbien/${ttdl.tieude}.htm?loadttdulich"><h6 class="card-title font-weight-bold">${ttdl.tieude}</h6></a>
   		   			<a href="dulichbien/${ttdl.tieude}.htm?loadttdulich" class="btn btn-primary btn-outline-success text-white"><i class="fas fa-info-circle"></i> Xem Thông Tin</a>
 		   	   </div>
           	</div>
          </div>
	  	</c:forEach>     
