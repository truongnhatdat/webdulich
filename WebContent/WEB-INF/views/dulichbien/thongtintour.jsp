...
<body>
 ...
 <div class="modal fade" id="myModal">
    ...
    <div class="container tieude text-info">
    	...
    	<div><p><a href="dulichbien/trangchu.htm">Trang chủ</a> <i class="fas fa-angle-right"></i> ${tour.tenTour}</p></div>
   		 </div>
	</div>
        	...
        	<div class="col-md-8 col-sm-8 col-xs-12">
                 <h3>${tour.tenTour}</h3>
                    <br>
                    	...
                    	<p style="font-weight:bold; color:#2492FF;"><i class="fas fa-money-bill-alt"></i>Giá: <fmt:formatNumber value="${tour.gia}" type="number"/>đ</p>
                    	<p><i class="fas fa-calendar-alt"></i>Thời gian: ${tour.thoigian}</p>
                    	<p><i class="fas fa-clock"></i>Khởi hành: ${tour.khoihanh}</p>
                    	<p><i class="fas fa-car-side"></i>Di chuyển: ${tour.dichuyen}</p>
                    	<p><i class="fas fa-hotel"></i>Khách sạn: <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
                    	<br>
                    <form:form action="dulichbien/giohang1.htm" modelAttribute="cthd">
                  		<label>Tên Tour</label>
                 		<input class="form-control" name="tenTour" value="${tour.tenTour}" readonly="readonly"><br>
                		<label><i class="fas fa-users"></i> Số người lớn và trẻ em</label><br>
                    	<form:input type="number" path="songuoilon" placeholder="số người lớn"/>
                    	<form:errors path="Songuoilon" style="color: red;font-style: italic;"></form:errors>
                    	
                    	<form:input type="number" path="sotreem" placeholder="số trẻ em"/>
                    	<form:errors path="Sotreem" style="color: red;font-style: italic;"></form:errors><br>
                    	
                    	<label class="mt-4"><i class="fas fa-calendar-alt"></i> Chọn ngày đi và ngày về</label><br>
                    	<p>Ngày đi: <form:input type="date" path="ngaydi"/></p>
                    	<form:errors path="Ngaydi" style="color: red;font-style: italic;"></form:errors>
                    	<p>Ngày về: <form:input type="date" path="ngayve"/></p>
                    	<form:errors path="Ngayve" style="color: red;font-style: italic;"></form:errors><br>
                    	
                    	 <button class="btn btn-primary btn-outline-light border-dark" style="width:150px;">ĐẶT TOUR</button>
                    </form:form>
                <br>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
            	...
            	<c:forEach var="tdl" items="${tdlich}">
            		<div class="media mt-4">
    					<img src="resources/hinh/${tdl.hinhanh}" class="align-self-start mr-3" style="width:100px">
    					<div class="media-body">
      					<a href="dulichbien/${tdl.tenTour}.htm?load"><h5>${tdl.tenTour}</h5></a>
                    	<p style="font-weight:bold; color:#007CF9;"><fmt:formatNumber value="${tdl.gia}" type="number"/>đ</p>
                    	<small>${tdl.thoigian}</small>
    					</div>
           	    	</div>
            	</c:forEach>
