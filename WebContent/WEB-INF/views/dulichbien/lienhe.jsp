...
<body>
 ...
 <!-- phan model -->
	...
	<div class="container tieude text-info">
    	...
    	<div><p><a href="dulichbien/trangchu.htm">Trang chủ</a> <i class="fas fa-angle-right"></i>${tb} <i class="fas fa-angle-right"></i> ${message}</p></div>
   		 </div>
	</div>
    <div class="container mt-5">
    	<div class="row">
        	<div class="col-md-7 col-sm-12 col-xs-12">
                ...
                <br>
                <p>Hãy điền vào những nội dung dưới đây và gửi cho chúng tôi, chúng tôi sẽ trả lời sớm nhất có thể khi nhận được thông tin bạn gửi. Xin cảm ơn quý khách.</p>
                <form:form action="dulichbien/khachhanglienhe.htm" modelAttribute="khlienhe">
                	<div>
                    ...
                    <div class="mt-3">
                    	<label><strong>Số điện thoại</strong></label>
                 	    <br>
               		     <form:input class="form-control" type="number" path="sodienthoai" placeholder="Số điện thoại(*)"/>
               		     <form:errors path="Sodienthoai" style="color: red;font-style: italic;"></form:errors>
                    </div>
                    <div>
                    	<label><strong>Nội dung</strong></label>
                 	    <br>
               		     <form:textarea class="form-control form-control-lg" rows="4" path="noidung" placeholder="Nội dung"/>
                    </div>
                    <br>
                    <button class="btn btn-info" data-toggle="modal" data-target="#myModal2">Gửi tin nhắn</button>
                </form:form>
            </div>
            <div class="col-md-5 col-sm-12 col-xs-12 mt-5">
            	<div><img src="http://phuquytravel.com.vn/pic/banner/banne_636319247691439271.png" style="width:200px;"></a></div>
                <br>
                <p>Quý khách có thể liên hệ qua địa chỉ, số điện thoại hoặc email sau, công ty chúng tôi hân hạnh được phục vụ quý khách</p>
                <div>
                	<div class="media">
      ...
      <div class="modal fade" id="myModal2">
		...
		<div class="modal-dialog modal-sm">
         <div class="modal-content">
        	<!-- Modal Header -->
        	<div class="modal-header">
          		<h6 class="modal-title">THÔNG TIN QUÝ KHÁCH ĐÃ ĐƯỢC GHI LẠI.CẢM ƠN QUÝ KHÁCH</h6>
        	</div>
        	<!-- Modal body -->
        	<div class="modal-body">
         		 <p>Chúng tôi sẽ sớm liên lạc qua điện thoại hoặc trả lời qua mail cho quý khách.</p>
