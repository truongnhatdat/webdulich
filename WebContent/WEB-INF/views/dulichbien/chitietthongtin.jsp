...
<!-- phan model -->
	...
	<div class="container tieude text-info">
    	...
    	<div><p><a href="dulichbien/trangchu.htm">Trang chủ</a> <i class="fas fa-angle-right"></i>Thông tin du lịch <i class="fas fa-angle-right"></i>${ttdlich.tieude}</p></div>
   		 </div>
	</div>
...
<div class="container mt-2">
	<div class="row mt-5">
        ...
        <div class="col-md-10 col-sm-12 col-xs-12">
        	<div><h3><strong>${ttdlich.tieude}</strong></h3></div>
        	<br>
        	<div>${ttdlich.noidung}</div>
        </div>
        <!-- cot ben phai -->
        <div class="col-md-2 colsm-12 col-xs-12 clear-fix">
            ...
            <ul class="list-unstyled mt-4">
            	<c:forEach var="tdl" items="${ttdl}">
            		<li class="media my-4">
    				<a href="dulichbien/${tdl.tieude}.htm?loadttdulich"><img src="resources/hinh/${tdl.hinhanh}" style="width:110px; height:90px;" class="mr-3"></a>
   				    <div class="media-body">
      					<a href="dulichbien/${tdl.tieude}.htm?loadttdulich"><p>${tdl.tieude}</p></a>
                        <i class="fas fa-clock"></i> <fmt:formatDate value="${tdl.ngaydang}" pattern="dd/MM/yyyy" />
   				    </div>
  				  </li>
            	</c:forEach>						
			</ul>
